...
import com.rvmagrini.registerverificationlogin.appuser.AppUserRepository;
...
import com.rvmagrini.registerverificationlogin.email.EmailSender;
...
public class RegistrationService {
	...
	public String register(RegistrationRequest request) {
		...
		if (userExists) {
			AppUser userDB = appUserRepository.findByEmail(request.getEmail()).get();
			
			if (bCryptPasswordEncoder.matches(request.getPassword(), userDB.getPassword()) &&
				!userDB.getEnabled()) {
				...
				String msg = "Your account was not verified yet. ";

				
				emailSender.send(
						userDB.getEmail(), 
						buildEmail(userDB.getFirstName(), msg, link));
		...
		emailSender.send(request.getEmail(), buildEmail(request.getFirstName(), msg, link));
	...
	public String confirmToken(String token) {
		...
		return "token confirmed, user enabled";
		
	}
	
	
	public String buildEmail(String name, String msg, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> " + msg + "Please click on the below link to activate your account: </p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\"" + link + "\">Activate Now</a> </p></blockquote>\n Link will expire in 15 minutes. <p>See you soon</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
